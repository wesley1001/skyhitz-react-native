...
RCT_EXPORT_METHOD(seekTo:(nonnull NSNumber *)reactTag seconds:(float)seconds)
{
    [self.bridge.uiManager addUIBlock:
     ^(__unused RCTUIManager *uiManager, RCTSparseArray *viewRegistry){
         ...
         if ([youtube isKindOfClass:[RCTYouTube class]]) {
             [youtube seekToSeconds:seconds allowSeekAhead:@YES];
         } else {
...
RCT_EXPORT_VIEW_PROPERTY(duration, NSString);
