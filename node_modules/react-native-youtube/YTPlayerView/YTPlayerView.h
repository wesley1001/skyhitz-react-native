...
/**
 * Force pause playback on a playing video. Corresponds to this method from
 * the JavaScript API:
 *   https://developers.google.com/youtube/iframe_api_reference#pauseVideo
 */
- (void)hardPauseVideo;
...
/**
 * Set volume from the player. Corresponds to this method from
 * the JavaScript API:
